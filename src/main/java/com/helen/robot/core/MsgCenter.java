...
public class MsgCenter {
	 ...
	 * @return
	 */
	public static JSONArray produceMsg(JSONArray msgList, CoreInfo coreInfo) {
		CoreInfo core = coreInfo;
	 ...
	 */
	public static void handleMsg(IMsgHandlerFace msgHandler, CoreInfo coreInfo) {
		while (true) {
			CoreInfo core = coreInfo;
			MessageTools messageTools = core.getMessageTools();
					...
					if (msg.getType() != null) {
						try {
							if (msg.getType().equals(MsgTypeEnum.TEXT.getType())) {
								...
								// messageTools.sendFileMsgByNickName("glowd",
								// "/Users/glowd/spider/loopring.txt");
